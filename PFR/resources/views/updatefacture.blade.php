...
<body>
    ...
    <div class="wrapper wrapper-content">
        <h1 class="text-center">Update  Deals</h1><br><br>
        <div class="row d-flex justify-content-center">
            <div class="col-6">
               


                <form method="Post" action="{{ route('Facture.update',[$post->id])}}"  enctype="multipart/form-data">
                    @csrf 
                    @method('PUT')
                    <div class="form-group row">
                      <label for="" class="col-3 col-form-label">Manager Name</label> 
                      <div class="col-5">
                      <input id="" name="ID_manager" value="{{$ID_manager[0]->name}}" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="" class="col-3 col-form-label">Client Name</label> 
                      <div class="col-5">
                        <input id="" name="ID_client" value="{{$ID_client[0]->name}}" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-5">
                        <input id="" name="Subject" value="{{$post->Subject}}" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-5">
                        <textarea id="" name="Desc"  cols="40" rows="3" class="form-control">{{$post->Desc}}</textarea>
                      </div>
                    </div> 
                    <div class="form-group row">
